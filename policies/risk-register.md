...
|----|------|---|---|-----------|----------|-------|-------|
| R1 | Key-person: single founder is a bus-factor of one | 3 | 4 | Mitigate/Accept | CTRL-04, CTRL-09 | dorkalev | Documented runbooks, IaC, protected evidence, backups; residual concentration explicitly accepted |
...
| R7 | Fraud / insider misuse of concentrated founder access (CC3.3) | 2 | 4 | Mitigate/Accept | CTRL-03, CTRL-04, CTRL-06, CTRL-14, CTRL-15 | dorkalev | No human SoD is claimed; least privilege, required machine gates, audit trail, archive reconciliation, periodic CPA scrutiny; residual risk accepted |
